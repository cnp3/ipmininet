...
\draw[thick,-, color=red] (4.25,-1.75) -- (4.25,-0.25);
\draw[thick,-, color=green] (3.75,-1.75) -- (3.75,-0.25);
\draw[thick,-, color=green] (S1) -- (S3);
\draw[thick,-, color=green] (S1) -- (S5);
\draw[thick,-, color=green] (S3) -- (S4);
\draw[thick,-, color=red] (S3) -- (S5);
\draw[thick,-, color=green] (S3) -- (S6);
\draw[thick,-, color=red] (S4) -- (S5);
\draw[thick,-, color=red] (S5) -- (5,-4) -- (5,1) -- (0,1) -- (S6);
