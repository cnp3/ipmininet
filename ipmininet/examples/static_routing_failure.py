"""This file contains an example of failure using static routing.
   You should only modify one routing table to make all the network work."""
...
class StaticRoutingNetFailure(IPTopo):
    ...
    def build(self, *args, **kwargs):
        ...
        r1.addDaemon(STATIC, static_routes=[
                                            ...
                                            StaticRoute("2042:66::2", "2042:16::2"),
                                            StaticRoute("2042:44::2", "2042:12::2"),
                                           ])
        r2.addDaemon(STATIC, static_routes=[
                                            StaticRoute("2042:11::2", "2042:25::2"),
                                            StaticRoute("2042:33::2", "2042:25::2"),
                                            StaticRoute("2042:44::2", "2042:24::2"),
                                            StaticRoute("2042:66::2", "2042:12::1")
                                           ])
        ...
        r4.addDaemon(STATIC, static_routes=[
                                            ...
                                            StaticRoute("2042:66::2", "2042:45::2"),
                                            StaticRoute("2042:33::2", "2042:34::1")
                                           ])
        r5.addDaemon(STATIC, static_routes=[
                                            StaticRoute("2042:11::2", "2042:23::2"), # 2042:56::2
                                            StaticRoute("2042:33::2", "2042:56::1"), # 2042:35::1
                                            StaticRoute("2042:44::2", "2042:56::1"), # 2042:45::1
                                            StaticRoute("2042:66::2", "2042:45::1"), # 2042:25::1
                                           ])
        r6.addDaemon(STATIC, static_routes=[
                                            StaticRoute("2042:11::2", "2042:16::1"),
                                            StaticRoute("2042:33::2", "2042:56::1"),
                                            StaticRoute("2042:44::2", "2042:16::1"),
                                           ])
