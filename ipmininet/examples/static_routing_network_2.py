...
class StaticRoutingNet2(IPTopo):
    ...
    def build(self, *args, **kwargs):
        ...
        # Add static routes
        # TODO: To make it worth, should delete all the non-static routes computed after start
        r1.addDaemon(STATIC, static_routes=[StaticRoute("2042:2b::/64", "2042:12::2"), # h2->r2
                                            StaticRoute("10.62.0.0/24", "10.12.0.2"),
                                            StaticRoute("2042::/16", "2042:13::3"), # /->r3
                                            StaticRoute("10.0.0.0/8", "10.13.0.3"),
                                            StaticRoute("10.73.0.0/24", "10.13.0.3")
                                           ])
        r2.addDaemon(STATIC, static_routes=[StaticRoute("2042:1a::/64", "2042:12::1"), # h1->r1
                                            StaticRoute("10.51.0.0/24", "10.12.0.1"),
                                            StaticRoute("2042:3c::/64", "2042:24::4"), # h3->r4
                                            StaticRoute("10.73.0.0/24", "10.24.0.4"),
                                            StaticRoute("2042:4d::/64", "2042:24::4"), # h4->r4
                                            StaticRoute("10.84.0.0/24", "10.24.0.4")
                                           ])
        r3.addDaemon(STATIC, static_routes=[StaticRoute("2042::/16", "2042:34::4"), # /->r4
                                            StaticRoute("10.0.0.0/8", "10.34.0.4"),
                                            StaticRoute("10.62.0.0/24", "10.34.0.4")
                                           ])
        r4.addDaemon(STATIC, static_routes=[StaticRoute("2042:1a::/64", "2042:14::1"), # h1->r1
                                            StaticRoute("10.51.0.0/24", "10.14.0.1"),
                                            StaticRoute("2042:2b::/64", "2042:24::2"), # h2->r2
                                            StaticRoute("10.62.0.0/24", "10.24.0.2"),
                                            StaticRoute("2042:3c::/64", "2042:14::1"), # h3->r1
                                            StaticRoute("10.73.0.0/24", "10.14.0.1")
                                           ])
